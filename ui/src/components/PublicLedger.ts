...
export function PublicLedger({ledgerId, publicParty, httpBaseUrl, wsBaseUrl, defaultToken, reconnectThreshold, dev, children} : PropsWithChildren<PublicProp>) {
